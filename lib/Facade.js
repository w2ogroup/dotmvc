...
/**
 * Expose an instance's API on a static class, with the ability to runtime swap
 * the instance (for mocking) as well as use an IoC resolver.
 * @constructor
...
/**
 * Method used to determine current instance this facade is using.
...
/**
 * Swap in a different instance into the facade for our static API.
...
/**
 * Function that should return a string we used to resolve our instance (if we
 * want to use an IoC container)
 ...
 * facade. Will first un-map all bound functions.
 */
Facade.map = function()
{
  this.unmap();
