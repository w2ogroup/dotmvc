var mixin_   = require('./util/mixin.js');
var Backbone = require('backbone');

module.exports = Observable;
mixin_(Observable, Backbone.Events);
 ...
 * var mixin_    = require('dotmvc/lib/util/mixin');
 *
