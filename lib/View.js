...
{
  this.$element.trigger(View.SIGNAL_PROPAGATE, parameter);
};
...
{
  // First try the view, then our context 
  Signal.attemptSignalHandle(this, signal);
  Signal.attemptSignalHandle(this.context, signal);
};
