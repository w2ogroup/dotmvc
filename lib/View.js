...
module.exports = (function() {
  ...
  function View(domElement, id)
  {
    ...
    var element = domElement || document.createElement(T.DOM_NODE);
  ...
  {
    if (this.couldHtmlGetClobbered())
      console.warn('DOM identity not safe! addView() is dangerous');
  ...
  View.prototype.couldHtmlGetClobbered = function()
  {
  ...
  {
    if (this.couldHtmlGetClobbered())
      console.warn('DOM identity not safe! createViews() is dangerous');
